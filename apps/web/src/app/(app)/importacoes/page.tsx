...
export default async function ImportsPage({
  ...
  if (!session?.permissions.includes('manage_imports'))
    return (
      <main className="page-content">
        <section className="empty-card">
          <h1>Importações indisponíveis</h1>
          <p>Seu perfil não possui acesso à migração de dados desta empresa.</p>
        </section>
      </main>
    );
