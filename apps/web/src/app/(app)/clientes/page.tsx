...
} from '@/components/customers/customer-directory';
  ...
  return (
    <main className="page-content">
        ...
        metrics={[
          {
            ...
            detail: 'Na empresa atual',
            icon: 'customers',
          },
          {
            label: 'Ativos nesta página',
            value: customers.items.filter(
          ...
          },
          {
            ...
            detail: q ? 'Para a busca atual' : 'Na página atual',
            icon: 'search',
          },
        ]}
      />
      ...
      <CustomerDirectory
        ...
        canManage={canManage}
        initialOpen={newAction === 'customer'}
        query={q}
      />
