    ...
    items: [
      {
        ...
        label: 'Financeiro',
        icon: 'finance',
        permission: 'view_financial_accounts',
      },
    ],
  },
  {
...
export function AppNavigation({
  ...
  const mobileItems = groups
    ...
    .filter((item) =>
      ['/inicio', '/vendas', '/estoque', '/financeiro'].includes(item.href),
    );
  ...
  return (
    <>
      ...
      >
        <div className="sidebar-header">
          <Link className="brand" href="/inicio">
            ...
            <span className="brand-text">MAFA Store</span>
          </Link>
          <button
          ...
          >
            <AppIcon name={collapsed ? 'chevronsRight' : 'chevronsLeft'} />
          </button>
        </div>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-account">
            <span className="account-shield">
              <AppIcon name="shield" />
            </span>
            <span className="sidebar-account-copy">
              <strong>{userName}</strong>
              <small>{roleLabels[roleName] ?? roleName}</small>
            </span>
      ...
      <nav
        ...
        style={{ '--mobile-nav-items': mobileItems.length } as CSSProperties}
      >
