    ...
    <section className="contact-directory">
      ...
      {editOpen && (
        <tr>
          <td colSpan={5}>
            <form
              className="settlement-form table-edit-form"
              onSubmit={submitEdit}
              noValidate
            >
              <div className="form-grid">
                ...
                <div className="field">
                  <label htmlFor={`edit-whatsapp-${contact.id}`}>
                    WhatsApp
                  </label>
                  <input
                    id={`edit-whatsapp-${contact.id}`}
                    name="whatsapp"
                ...
                {kind === 'cliente' ? (
                  <>
                    <div className="field">
                      <label htmlFor={`edit-instagram-${contact.id}`}>
                        Instagram
                      </label>
                      <input
                        id={`edit-instagram-${contact.id}`}
                        name="instagram"
                        defaultValue={contact.instagram ?? ''}
                      />
                    </div>
                    <div className="field">
                      <label htmlFor={`edit-birth-date-${contact.id}`}>
                        Data de nascimento
                      </label>
                      <input
                        id={`edit-birth-date-${contact.id}`}
                        name="birthDate"
                        type="date"
                  ...
                  <>
                    <div className="field">
                      <label htmlFor={`edit-document-${contact.id}`}>
                        Documento
                      </label>
                      <input
                        id={`edit-document-${contact.id}`}
                        name="document"
                    ...
                    <div className="field">
                      <label htmlFor={`edit-contact-name-${contact.id}`}>
                        Pessoa de contato
                      </label>
                      <input
